...
export async function PUT(
  ...
  try {
    ...
    console.error(e);
    return NextResponse.json({ success: false, error: "Failed to rename translation table" }, { status: 500 });
  }
}
